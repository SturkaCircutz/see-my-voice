...
export const toastClass =
  "pointer-events-none absolute right-[18px] bottom-[82px] left-[18px] z-[8] translate-y-2 rounded-xl bg-[rgba(25,26,47,0.94)] px-3.5 py-3 text-xs leading-[1.45] text-white opacity-0 transition-[opacity,transform] duration-[180ms]";
